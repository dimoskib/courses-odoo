...
class AllCourses(http.Controller):
    ...
    def show_custom_page(self, **kw):
        ...
        return http.request.render('new_module.courses_page_template', values)
...
class AllTeachers(http.Controller):
    ...
    def show_custom_page(self, **kw):
        ...
        return http.request.render('new_module.teachers_page_template', values)
...
class AllStudents(http.Controller):
    ...
    def show_custom_page(self, **kw):
        ...
        return http.request.render('new_module.students_page_template', values)
